package com.grades.appeal.client;

import static com.grades.appeal.model.OrderBuilder.order;

import java.net.URI;
import java.net.URISyntaxException;

import com.grades.appeal.client.activities.Actions;
import com.grades.appeal.client.activities.GetReceiptActivity;
import com.grades.appeal.client.activities.PaymentActivity;
import com.grades.appeal.client.activities.PlaceOrderActivity;
import com.grades.appeal.client.activities.ReadOrderActivity;
import com.grades.appeal.client.activities.UpdateOrderActivity;
...
public class Main {
    ...
    private static final String ENTRY_POINT_URI = "http://localhost:8080/GradeAppealServer/webresources/order";
