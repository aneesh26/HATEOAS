 ...
 * @author A
 */
public class WithdrawAppealActivity {

    public WithdrawAppealActivity() {
    }
    
    public AppealRepresentation withdraw(AppealServerUri appealUri) {
        ...
        storedAppeal.setStatus(AppealStatus.WITHDRAWN);
        Date date = new Date();
        storedAppeal.setAppealContent(storedAppeal.getAppealContent() + "\n\nAppeal withdrawn on: " + date.toString());
