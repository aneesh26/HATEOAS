...
import edu.asu.mscs.ashastry.appealserver.model.Payment;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

@XmlRootElement(name = "payment", namespace = Representation.APPEALS_NAMESPACE)
public class PaymentRepresentation extends Representation {
    ...
    @XmlElement(namespace = PaymentRepresentation.APPEALS_NAMESPACE) private double amount;
    @XmlElement(namespace = PaymentRepresentation.APPEALS_NAMESPACE) private String cardholderName;
    @XmlElement(namespace = PaymentRepresentation.APPEALS_NAMESPACE) private String cardNumber;
    @XmlElement(namespace = PaymentRepresentation.APPEALS_NAMESPACE) private int expiryMonth;
    @XmlElement(namespace = PaymentRepresentation.APPEALS_NAMESPACE) private int expiryYear;
